...
public abstract class Niveau {
	...
	/**
	 * Fonction retournant le block à placer sur notre fenêtre, en fonction du chiffre qui a été défini sur la variable "matriceNiveau"
	 * @param chiffre un des chiffre qui a été défini sur la variable "matriceNiveau"
	 * @return Block le block à placer sur notre fenêtre
	 */
	public Block generateBlock(int chiffre) {
		...
		case 10:
			...
			block.setHardBlock(true);
			block.setSpecialBlock(true);
			break;
		case 11:
			block = new Block("blocSpecial2.png");
			block.setHardBlock(true);
			block.setSpecialBlock(true);
			break;
		default:
